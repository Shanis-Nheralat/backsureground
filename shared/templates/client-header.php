 ...
 * 
 * Displays the header for client pages
 */

// Check if user is logged in
if (!function_exists('is_admin_logged_in') || !is_admin_logged_in() || $_SESSION['admin_role'] !== 'client') {
    // Redirect to login page if not logged in as client
...
$client_name = $_SESSION['admin_name'] ?? 'Client';

// Get notifications if function exists
$notifications = function_exists('get_client_notifications') ? get_client_notifications($client_id) : [];
$unread_count = 0;
...
// Page title
$page_title = isset($page_title) ? $page_title . ' | Backsure Global Support' : 'Client Dashboard | Backsure Global Support';
?>
<!DOCTYPE html>
<html lang="en">
<head>
...
<body class="client-layout">
    <div class="wrapper">
        <!-- Include Sidebar -->
        <?php include __DIR__ . '/client-sidebar.php'; ?>
                        ...
                        <div class="dropdown-menu dropdown-menu-end">
                            <div class="dropdown-header">
                                ...
                                <?php if (!empty($notifications)): ?>
                                    <a href="/client/notifications.php" class="text-decoration-none">View All</a>
                                <?php endif; ?>
                            </div>
                    ...
                    <div class="dropdown user-dropdown">
                        <button class="btn d-flex align-items-center gap-2" type="button" data-bs-toggle="dropdown" aria-expanded="false">
                            <div class="user-avatar">
                                <span><?php echo get_initials($client_name); ?></span>
                            </div>
                            <div class="user-info d-none d-md-block">
                                <span class="user-name"><?php echo $client_name; ?></span>
