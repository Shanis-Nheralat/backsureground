...
if (!isset($_GET['id']) || !is_numeric($_GET['id'])) {
    ...
    header('Location: assigned-tickets.php');
    exit;
}

$ticket_id = intval($_GET['id']);

// Verify employee can access this ticket
if (!can_access_ticket($ticket_id, $employee_id, 'employee')) {
...
// Process form submission for reply
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (empty($errors)) {
        ...
        $reply_id = add_ticket_reply(
            ...
            'employee', 
            $message, 
            0, // employees cannot add internal notes
...
// Get ticket replies (including internal notes for employees)
...
$breadcrumbs = [
    ...
    ['title' => 'Support Tickets', 'url' => '/employee/support/assigned-tickets.php'],
...
<main class="admin-main">
    <div class="container-fluid py-4">
        ...
        <div class="d-flex justify-content-between align-items-center mb-4">
            ...
            <div>
                <a href="assigned-tickets.php" class="btn btn-outline-secondary">
                                    ...
                                    <div>
                                        ...
                                        <?php elseif ($reply['sender_role'] === 'employee'): ?>
                                            <span class="badge bg-info">
                                                <?php echo $reply['sender_id'] == $employee_id ? 'You' : 'Staff: ' . htmlspecialchars($reply['sender_name']); ?>
                                            </span>
                                        <?php else: ?>
                ...
                <div class="card-body">
                    ...
                    <form method="post" enctype="multipart/form-data">
                        ...
                        <div class="mb-3">
                            ...
                            <small class="text-muted">Allowed file types: PDF, Word, Excel, ZIP, JPG, PNG (Max 10MB each, Max 3 files)</small>
                        </div>
        ...
        <?php else: ?>
            <div class="alert alert-info">
                <i class="fas fa-info-circle me-2"></i> This ticket is closed. Please contact an admin if you need to add more information.
            </div>
        <?php endif; ?>
    </div>
</main>
